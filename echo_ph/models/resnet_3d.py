...
def get_resnet3d_18(num_classes=2, model_name='r2plus1d_18', pretrained=True):
    """

    :param num_classes: 2 or 3
    :param model_name: One of r2plus1d_18, mc3_18, r3d_18
    :param pretrained: True or False
    :return:
    """
    model = models.video.__dict__[model_name](pretrained=pretrained)
    in_channels = 1
