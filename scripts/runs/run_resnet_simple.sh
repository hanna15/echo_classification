...
bsub -R "rusage[mem=4096, ngpus_excl_p=1]" -W 04:00 -n 6 \
	"python scripts/train_simple.py --cache_dir ~/.heart_echo --label_type 2class_drop_ambiguous --k $1 --augment --hist --class_balance_per_epoch --model res_simple --optimizer adamw --dropout $2"
