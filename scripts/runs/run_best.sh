...
for fold in {0..9}; do
    ...
    bsub -R "rusage[mem=2048, ngpus_excl_p=1]" -W 04:00 -n 6 \
      "python scripts/train_simple.py --run_id crop_c_random10_corr --min_expansion --max_epochs 300 --max_p 95 --batch_size 64 --res_dir results_crop --eval_metrics video-b-accuracy/valid --cache_dir ~/.heart_echo --k 10 --fold ${fold} --hist --class_balance_per_epoch --augment --aug_type 3 --optimizer adam --pretrained"
    #bsub -R "rusage[mem=2048, ngpus_excl_p=1]" -W 04:00 -n 6 \
    ...
    #bsub -R "rusage[mem=2048, ngpus_excl_p=1]" -W 04:00 -n 6 \
    #  "python scripts/train_simple.py --run_id crop_corners --max_epochs 300 --max_p 95 --batch_size 64 --res_dir results_crop  --eval_metrics video-b-accuracy/valid --cache_dir ~/.heart_echo --k 10 --fold ${fold} --hist --class_balance_per_epoch --augment --aug_type 4 --optimizer adam --pretrained"
    #bsub -R "rusage[mem=2048, ngpus_excl_p=1]" -W 04:00 -n 6 \
